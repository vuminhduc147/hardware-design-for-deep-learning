...
`define AUTOTB_DUT      conv2D_conv2D
`define AUTOTB_DUT_INST AESL_inst_conv2D_conv2D
`define AUTOTB_TOP      apatb_conv2D_top
`define AUTOTB_LAT_RESULT_FILE "conv2D_conv2D.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "conv2D_conv2D.performance.result.transaction.xml"
...
`define AUTOTB_TVIN_gmem0  "./c.conv2D_conv2D.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1  "./c.conv2D_conv2D.autotvin_gmem1.dat"
`define AUTOTB_TVIN_input_0  "./c.conv2D_conv2D.autotvin_input_0.dat"
`define AUTOTB_TVIN_input_1  "./c.conv2D_conv2D.autotvin_input_1.dat"
`define AUTOTB_TVIN_input_2  "./c.conv2D_conv2D.autotvin_input_2.dat"
`define AUTOTB_TVIN_input_3  "./c.conv2D_conv2D.autotvin_input_3.dat"
`define AUTOTB_TVIN_input_4  "./c.conv2D_conv2D.autotvin_input_4.dat"
`define AUTOTB_TVIN_kernel_0  "./c.conv2D_conv2D.autotvin_kernel_0.dat"
`define AUTOTB_TVIN_kernel_1  "./c.conv2D_conv2D.autotvin_kernel_1.dat"
`define AUTOTB_TVIN_kernel_2  "./c.conv2D_conv2D.autotvin_kernel_2.dat"
`define AUTOTB_TVIN_output_r  "./c.conv2D_conv2D.autotvin_output_r.dat"
`define AUTOTB_TVIN_gmem0_out_wrapc  "./rtl.conv2D_conv2D.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "./rtl.conv2D_conv2D.autotvin_gmem1.dat"
`define AUTOTB_TVIN_input_0_out_wrapc  "./rtl.conv2D_conv2D.autotvin_input_0.dat"
`define AUTOTB_TVIN_input_1_out_wrapc  "./rtl.conv2D_conv2D.autotvin_input_1.dat"
`define AUTOTB_TVIN_input_2_out_wrapc  "./rtl.conv2D_conv2D.autotvin_input_2.dat"
`define AUTOTB_TVIN_input_3_out_wrapc  "./rtl.conv2D_conv2D.autotvin_input_3.dat"
`define AUTOTB_TVIN_input_4_out_wrapc  "./rtl.conv2D_conv2D.autotvin_input_4.dat"
`define AUTOTB_TVIN_kernel_0_out_wrapc  "./rtl.conv2D_conv2D.autotvin_kernel_0.dat"
`define AUTOTB_TVIN_kernel_1_out_wrapc  "./rtl.conv2D_conv2D.autotvin_kernel_1.dat"
`define AUTOTB_TVIN_kernel_2_out_wrapc  "./rtl.conv2D_conv2D.autotvin_kernel_2.dat"
`define AUTOTB_TVIN_output_r_out_wrapc  "./rtl.conv2D_conv2D.autotvin_output_r.dat"
`define AUTOTB_TVOUT_gmem2  "./c.conv2D_conv2D.autotvout_gmem2.dat"
`define AUTOTB_TVOUT_gmem2_out_wrapc  "./impl_rtl.conv2D_conv2D.autotvout_gmem2.dat"
module `AUTOTB_TOP;
...
initial begin : dump_tvout_runtime_sign_gmem2
    ...
    fp = $fopen(`AUTOTB_TVOUT_gmem2_out_wrapc, "w");
    if (fp == 0) begin
    ...
    @ (posedge AESL_clock);
    @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_gmem2_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_gmem2_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
