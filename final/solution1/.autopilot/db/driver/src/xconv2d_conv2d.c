...
void XConv2d_conv2d_Set_input_r(XConv2d_conv2d *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv2d_conv2d_WriteReg(InstancePtr->Axilites_BaseAddress, XCONV2D_CONV2D_AXILITES_ADDR_INPUT_R_DATA, (u32)(Data));
    XConv2d_conv2d_WriteReg(InstancePtr->Axilites_BaseAddress, XCONV2D_CONV2D_AXILITES_ADDR_INPUT_R_DATA + 4, (u32)(Data >> 32));
}

u64 XConv2d_conv2d_Get_input_r(XConv2d_conv2d *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XConv2d_conv2d_ReadReg(InstancePtr->Axilites_BaseAddress, XCONV2D_CONV2D_AXILITES_ADDR_INPUT_R_DATA);
    Data += (u64)XConv2d_conv2d_ReadReg(InstancePtr->Axilites_BaseAddress, XCONV2D_CONV2D_AXILITES_ADDR_INPUT_R_DATA + 4) << 32;
    return Data;
}

void XConv2d_conv2d_Set_kernel(XConv2d_conv2d *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv2d_conv2d_WriteReg(InstancePtr->Axilites_BaseAddress, XCONV2D_CONV2D_AXILITES_ADDR_KERNEL_DATA, (u32)(Data));
    XConv2d_conv2d_WriteReg(InstancePtr->Axilites_BaseAddress, XCONV2D_CONV2D_AXILITES_ADDR_KERNEL_DATA + 4, (u32)(Data >> 32));
}

u64 XConv2d_conv2d_Get_kernel(XConv2d_conv2d *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XConv2d_conv2d_ReadReg(InstancePtr->Axilites_BaseAddress, XCONV2D_CONV2D_AXILITES_ADDR_KERNEL_DATA);
    Data += (u64)XConv2d_conv2d_ReadReg(InstancePtr->Axilites_BaseAddress, XCONV2D_CONV2D_AXILITES_ADDR_KERNEL_DATA + 4) << 32;
    return Data;
}
