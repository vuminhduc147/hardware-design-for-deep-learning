...
void conv2D(int input[5][5],
            int kernel[3][3],
            int output[(5 - 3 + 1)][(5 - 3 + 1)]) {_ssdm_SpecArrayDimSize(input, 5);_ssdm_SpecArrayDimSize(kernel, 3);_ssdm_SpecArrayDimSize(output, 3);

_ssdm_op_SpecInterface(0, "s_axilite", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(input, "m_axi", 0, 0, "", 0, 0, "gmem0", "slave", "", 16, 16, 16, 16, "", "");
_ssdm_op_SpecInterface(kernel, "m_axi", 0, 0, "", 0, 0, "gmem1", "slave", "", 16, 16, 16, 16, "", "");
_ssdm_op_SpecInterface(output, "m_axi", 0, 0, "", 0, 0, "gmem2", "slave", "", 16, 16, 16, 16, "", "");
