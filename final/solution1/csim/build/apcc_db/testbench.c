...
if (AESL_DEBUG_TRACE)
printf("\n  call void @conv2D([5 x i32]* %%14, [3 x i32]* %%15, [3 x i32]* %%16) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_27_count);
  conv2D(llvm_cbe_tmp__14, llvm_cbe_tmp__15, llvm_cbe_tmp__16);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
