# ==============================================================
# File generated on Wed Dec 18 10:00:40 +0700 2024
...
if {[file isfile conv2D_conv2D.autotvin.dat]} {
	file delete -force conv2D_conv2D.autotvin.dat
}

if {[file isfile conv2D_conv2D.autotvout.dat]} {
	file delete -force conv2D_conv2D.autotvout.dat
}
