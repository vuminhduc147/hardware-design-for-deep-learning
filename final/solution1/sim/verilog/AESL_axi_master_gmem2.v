...
//------------------------Parameter----------------------
`define TV_IN_gmem2 "../tv/cdatafile/c.conv2D_conv2D.autotvin_gmem2.dat"
`define TV_OUT_gmem2 "../tv/rtldatafile/rtl.conv2D_conv2D.autotvout_gmem2.dat"
...
parameter gmem2_mem_depth = 32'd 9;
...
output [64 - 1 : 0] TRAN_gmem2_output_r;
input ready;
input done;
...
assign    TRAN_gmem2_output_r = output_r;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem2_mem_depth) begin
                $display ("C:/Users/Admin/Downloads/btl/final/solution1/sim/verilog/AESL_axi_master_gmem2.v: Write request address %d exceed AXI master gmem2 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem2_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem2_mem_depth) begin
                $display ("C:/Users/Admin/Downloads/btl/final/solution1/sim/verilog/AESL_axi_master_gmem2.v: Read request address %d exceed AXI master gmem2 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem2_mem_depth); 
                $finish;
            end
...
initial begin : write_file_proc 
  ...
  while(1) begin 
      ...
      if (factor == 2) begin
          if ((gmem2_mem_depth - 1) % factor == 0) begin
              case(mem_page)
                  0 : $fdisplay(fp,"0x%x",gmem2_mem_0[gmem2_mem_depth/factor][15:0]);
                  1 : $fdisplay(fp,"0x%x",gmem2_mem_1[gmem2_mem_depth/factor][15:0]);
                  2 : $fdisplay(fp,"0x%x",gmem2_mem_2[gmem2_mem_depth/factor][15:0]);
                  3 : $fdisplay(fp,"0x%x",gmem2_mem_3[gmem2_mem_depth/factor][15:0]);
                  default: $display("The page_num of write file is not valid!");
              endcase
          end
      end
