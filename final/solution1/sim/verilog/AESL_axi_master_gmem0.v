...
//------------------------Parameter----------------------
`define TV_IN_gmem0 "../tv/cdatafile/c.conv2D_conv2D.autotvin_gmem0.dat"
`define TV_OUT_gmem0 "../tv/rtldatafile/rtl.conv2D_conv2D.autotvout_gmem0.dat"
...
parameter gmem0_mem_depth = 32'd 25;
...
output [64 - 1 : 0] TRAN_gmem0_input_0;
output [64 - 1 : 0] TRAN_gmem0_input_1;
output [64 - 1 : 0] TRAN_gmem0_input_2;
output [64 - 1 : 0] TRAN_gmem0_input_3;
output [64 - 1 : 0] TRAN_gmem0_input_4;
input ready;
input done;
...
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [64 - 1 : 0] input_0 = 0;
reg [64 - 1 : 0] input_1 = 0;
reg [64 - 1 : 0] input_2 = 0;
reg [64 - 1 : 0] input_3 = 0;
reg [64 - 1 : 0] input_4 = 0;
...
assign    TRAN_gmem0_input_0 = input_0;
assign    TRAN_gmem0_input_1 = input_1;
assign    TRAN_gmem0_input_2 = input_2;
assign    TRAN_gmem0_input_3 = input_3;
assign    TRAN_gmem0_input_4 = input_4;
...
initial begin : initialize_offset
  ...
  input_0 <= 0 * DATA_byte_num;
  input_1 <= 5 * DATA_byte_num;
  input_2 <= 10 * DATA_byte_num;
  input_3 <= 15 * DATA_byte_num;
  input_4 <= 20 * DATA_byte_num;
end
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem0_mem_depth) begin
                $display ("C:/Users/Admin/Downloads/btl/final/solution1/sim/verilog/AESL_axi_master_gmem0.v: Write request address %d exceed AXI master gmem0 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem0_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem0_mem_depth) begin
                $display ("C:/Users/Admin/Downloads/btl/final/solution1/sim/verilog/AESL_axi_master_gmem0.v: Read request address %d exceed AXI master gmem0 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem0_mem_depth); 
                $finish;
            end
