...
set sdx_kernel_files {C:/Users/Admin/Downloads/btl/conv2D.c}
set enable_xo_gen 1
set sdaccel_dir [file join [pwd] .. sdaccel]
set xo_hls_files_dir "C:/Users/Admin/Downloads/btl/final/solution1/impl/ip/hls_files"
set hdl_module_list {conv2D_conv2D_mul_32s_32s_32_4_1
...
set kernel_xo "C:/Users/Admin/Downloads/btl/conv2D.xo"

## Variables
set Top "conv2D_conv2D"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 input_0_1 W 0x0 "Data signal of input_0" {{0 32 input_0 W 0 "Bit 31 to 0 Data signal of input_0"}}} {0x14 input_0_2 W 0x0 "Data signal of input_0" {{0 32 input_0 W 0 "Bit 63 to 32 Data signal of input_0"}}} {0x1c input_1_1 W 0x0 "Data signal of input_1" {{0 32 input_1 W 0 "Bit 31 to 0 Data signal of input_1"}}} {0x20 input_1_2 W 0x0 "Data signal of input_1" {{0 32 input_1 W 0 "Bit 63 to 32 Data signal of input_1"}}} {0x28 input_2_1 W 0x0 "Data signal of input_2" {{0 32 input_2 W 0 "Bit 31 to 0 Data signal of input_2"}}} {0x2c input_2_2 W 0x0 "Data signal of input_2" {{0 32 input_2 W 0 "Bit 63 to 32 Data signal of input_2"}}} {0x34 input_3_1 W 0x0 "Data signal of input_3" {{0 32 input_3 W 0 "Bit 31 to 0 Data signal of input_3"}}} {0x38 input_3_2 W 0x0 "Data signal of input_3" {{0 32 input_3 W 0 "Bit 63 to 32 Data signal of input_3"}}} {0x40 input_4_1 W 0x0 "Data signal of input_4" {{0 32 input_4 W 0 "Bit 31 to 0 Data signal of input_4"}}} {0x44 input_4_2 W 0x0 "Data signal of input_4" {{0 32 input_4 W 0 "Bit 63 to 32 Data signal of input_4"}}} {0x4c kernel_0_1 W 0x0 "Data signal of kernel_0" {{0 32 kernel_0 W 0 "Bit 31 to 0 Data signal of kernel_0"}}} {0x50 kernel_0_2 W 0x0 "Data signal of kernel_0" {{0 32 kernel_0 W 0 "Bit 63 to 32 Data signal of kernel_0"}}} {0x58 kernel_1_1 W 0x0 "Data signal of kernel_1" {{0 32 kernel_1 W 0 "Bit 31 to 0 Data signal of kernel_1"}}} {0x5c kernel_1_2 W 0x0 "Data signal of kernel_1" {{0 32 kernel_1 W 0 "Bit 63 to 32 Data signal of kernel_1"}}} {0x64 kernel_2_1 W 0x0 "Data signal of kernel_2" {{0 32 kernel_2 W 0 "Bit 31 to 0 Data signal of kernel_2"}}} {0x68 kernel_2_2 W 0x0 "Data signal of kernel_2" {{0 32 kernel_2 W 0 "Bit 63 to 32 Data signal of kernel_2"}}} {0x70 output_r_1 W 0x0 "Data signal of output_r" {{0 32 output_r W 0 "Bit 31 to 0 Data signal of output_r"}}} {0x74 output_r_2 W 0x0 "Data signal of output_r" {{0 32 output_r W 0 "Bit 63 to 32 Data signal of output_r"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS m_axi_gmem0 m_axi_gmem1 m_axi_gmem2"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 45 II 25}
